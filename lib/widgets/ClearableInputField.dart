...
class _ClearableInputFieldState extends State<ClearableInputField> {
  ...
  Widget build(BuildContext context) {
    var _controller = (null == widget.controller) ? TextEditingController() : widget.controller;
...
//    FocusScope.of(context).requestFocus(new FocusNode());
  ...
  Widget _buildDefaultClearIcon(BuildContext context, TextEditingController controller) {
    return Visibility(
      child: InkWell(
        child: Icon(
          IconF.wrong,
